...
<html lang="en-us">
    ...
    <body>
        ...
        <div class="ui menu">
            ...
            <div class="right menu">
                <a href="#" class="item">
                    <div style="border-radius: 50%; background-color: white; height: 35px; width: 35px;"></div>
                </a>
            </div>
        </div>
        <div class="ui grid stackable container">
            <div class="row">
                <h1 class="title">
                    ...
                    <div class="sub header">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
                </h1>
            </div>
                ...
                <div class="ui items">
                    <div class="ui item" id="cardCharacter" style="width: 750px">
                        ...
                        <div class="content">
                            ...
                            <div class="extra">mais descricao</div>
                        </div>
                    </div>
    ...
    <script>
        $('.ui.indicating.tiny.progress').progress('increment', 50);
        $('.ui.indicating.tiny.progress').progress({
            text: {
